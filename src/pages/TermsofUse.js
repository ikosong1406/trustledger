          ...
          <div className="termDiv2">
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                or recommendation by Trustledger. Furthermore, there may be
                additional risks that Trustledger have not foreseen or named in
                this Terms of Use.
              </h3>
              <h3>
                2.6 Trustledger does not provide any investment advice in
                ...
                are made on your decision solely. Trustledger will not be liable
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                it to any third party. Trustledger has the right to disable any
            ...
            <div className="termDiv3">
              ...
              <h3>
                4.1 Trustledger implements and maintains the highest standards
                of Know Your Customer (“KYC”) processes and controls as part of
                our commitment to combating fraud and assisting in the
                prevention of money laundering and terrorist financing. While
                our industry is largely unregulated, Trustledger voluntarily
                adheres to local and international compliance standards in
                relation to customer due diligence. To ensure we meet these
                standards, our customers are required to provide certain
                personal details and documents when opening a Trustledger
                Account (“Identity Verification”). The nature and extent of the
                Identity Verification required will depend upon which of our
                supported countries you are resident in, and the deposit and
                withdrawal limits that you wish to apply to your Trustledger
                Account. In certain circumstances, Trustledger may also perform
                enhanced due diligence (“EDD”) procedures in relation to your
                Trustledger Account. You accept and agree that you will remain
                subject to such procedures at all times. For identity
                verification contact our site's online support. You accept and
                agree that there may be delays in accessing your Trustledger
                Account, or in carrying out transactions through your
                Trustledger Account, while we undertake any Identity
                Verification and/or EDD procedures. Retention of information.
                Trustledger is required to retain certain information and
                documentation obtained as part of the Identity Verification and
                EDD procedures. These requirements apply even when you have
                terminated your relationship with Trustledger. We reserve the
                right to keep such information and documentation for the
                required period and you accept and agree that information and
                documentation you provide to Trustledger may be retained by us,
                including following the closure of your Trustledger Account.
              </h3>
              <h3>
              ...
              <h3>
                4.3 Trustledger RESERVES THE RIGHT TO, AT ANY TIME: restrict or
                suspend your Trustledger Account when we, in our sole
                discretion, consider it necessary to carry out further Identity
                Verification and/or EDD; or terminate your Trustledger Account
                if you provide, or we suspect you have provided, false
                information or refuse to provide information we require for
                Identity Verification and/or EDD.
              </h3>
              <h3>
                4.4 Trustledger Account Capitalized terms not otherwise defined
                in these Terms will have the following meaning: Number of
                Trustledger Accounts. Payward may, in its sole discretion, limit
                the number of Trustledger Accounts that you may hold, maintain
                or acquire. Trustledger Account information and security. In
                order to engage in any trades via the Services, you must create
                a Trustledger Account and provide any requested information.
                When you create a Trustledger Account, you agree to: (a) create
                a strong password that you do not use for any other website or
                online service; (b) provide accurate and truthful information;
                (c) maintain and promptly update your Trustledger Account
                information; (d) maintain the security of your Trustledger
                Account by protecting your password and restricting access to
                your Trustledger Account; (e) promptly notify us if you discover
                or otherwise suspect any security breaches related to your
                Trustledger Account; and (f) Users with balance more then 0.25
                BTC must activate premium status. (g) take responsibility for
                all activities that occur under your Trustledger Account and
                accept all risks of any authorized or unauthorized access to
                your Trustledger Account, to the maximum extent permitted by
                law.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              <h1>5.EXCHANGE</h1>
              <h3>
                5.1 The Trustledger Exchange is an order book exchange platform
                ...
                using the Trustledger Exchange does so entirely at their own
                risk. The Trustledger Exchange is not offered to customers in
                all jurisdictions. This section of the Terms applies to you if
                you access and/or use the Trustledger Exchange.
              </h3>
              <h3>
                5.2 Trustledger may, at any time and in our sole discretion,
                refuse any trade, impose limits on the trade amount permitted,
                or impose any other conditions or restrictions upon your use of
                the Trustledger Exchange that we deem necessary. We may, for
                example, limit the number of open orders that you may establish
                or restrict trades from certain locations. Trustledger reserves
                the right to take such action without prior notice.
              </h3>
              <h3>
                5.3 IN ACCESSING AND/OR USING THE Trustledger EXCHANGE FOR ANY
                PURPOSE, YOU AGREE AND ACCEPT THAT: all trades executed on the
                Trustledger Exchange are executed automatically, based on the
                parameters of your order instructions, and cannot be reversed.
                In the case of technical issues affecting Trustledger internal
                systems, Trustledger may, where possible and in its sole
                discretion, take steps to reverse or otherwise amend a trade. By
                using the Trustledger Exchange, you accept and agree to all
                applicable fees; Trustledger makes no guarantee that the
                Trustledger Exchange will be available without interruption;
                that there will be no delays, failures, errors, omissions or
                loss of transmitted information; or that any order will be
                executed, accepted, recorded, or remain open;
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                processor, to charge or deduct your Trustledger Account Funds
                for any applicable Fees owed in connection with trades you
            ...
            <div className="termDiv3">
              <h1>8.SECURITY</h1>
              <h3>
                8.1 ACCOUNT SECURITY. Trustledger TAKES SECURITY VERY SERIOUSLY
                AND THE MEASURES WE HAVE IN PLACE TO PROTECT YOUR Trustledger
                ACCOUNT HOWEVER, YOU ARE SOLELY RESPONSIBLE FOR: maintaining
                adequate security and control over your Trustledger Account
                sign-in details, including but not limited to any passwords,
                personal identification numbers (PINs), API keys, or any other
                codes associated with your Trustledger Account; enabling any
                additional security features available to you, including the
                activation of two factor authentication on your Trustledger
                ...
                security; maintaining security and control over the email
                mailbox, phone number and two-factor authentication applications
                or devices associated with your Trustledger Account;
              </h3>
              <h3>
                ...
                your Trustledger Account and the loss or theft of any
                cryptocurrency and/or Local Currency balances held in your
                Trustledger Wallet or any linked bank account(s) and/or saved
                credit or debit card(s). Trustledger shall have no liability to
                you for or in connection with any unauthorised access to your
                Trustledger Account, where such unauthorised access was due to
                no fault of Trustledger, and/or any failure by you to act upon
                any notice or alert that we send to you.
              </h3>
              <h3>
                8.3 The security of your Trustledger Account may be compromised,
                or interruption caused to it, by phishing, spoofing or other
                attack, computer viruses, spyware, scareware, Trojan horses,
                worms or other malware that may affect your computer or other
                equipment. Trustledger strongly recommends that you regularly
                use reputable virus screening and prevention software and remain
              ...
              <h3>
                ...
                originate from Trustledger and, should you have any uncertainty
                regarding the authenticity of any communication, you should log
                in to your Trustledger Account through the Trustledger website
                and not any other domain name or website purporting to be, or to
                be related to, Trustledger to review any transactions or
                ...
                all activity that occurs in or through your Trustledger Account
                and accept all risks of any unauthorised or authorised access to
                your Trustledger Account.
              </h3>
              <h3>
              ...
              <h3>
                8.6 Private keys. Trustledger securely stores all Supported
                Cryptocurrency private keys (“Private Keys”) associated with any
                Trustledger Account. You accept and agree that Trustledger shall
                retain full ownership and control of the Private Keys associated
                with your Trustledger Account and that you shall have no control
                of, access to, or the ability to use, such Private Keys
              </h3>
              <h3>
                8.7 FOR EXAMPLE, BUT WITHOUT LIMITING THE GENERALITY OF THE
                FOREGOING, Trustledger WILL NOT: accept or adhere to any
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                operations, Trustledger does not provide any warranty in
                relation to the availability of the Trustledger Site or your
                Trustledger Account. Without limiting the generality of the
                foregoing, we do not guarantee continuous access to the
                Trustledger Site or your Trustledger Account and make no
                representation that the Trustledger Site, Trustledger API, your
                Trustledger Account and/or any products or services offered
                therein will be available without interruption; or that there
            ...
            <div className="termDiv3">
              ...
              <h3>
                10.1 When you use your Trustledger Account to send or receive
                ...
                confirming any such transactions. Trustledger cannot confirm,
              ...
              <h3>
                ...
                accordingly, and will not be included in your Trustledger Wallet
                balance or be available to you to conduct transactions; When you
                send cryptocurrency from your Trustledger Account, you are
                ...
                neither you or Trustledger will be able to cancel or otherwise
              ...
              <h3>
                10.3 SITE, YOU ACCEPT AND AGREE THAT: Trustledger is not
                ...
                you store in your Trustledger Account. Should a fork occur,
                Trustledger may, with or without notice to you, temporarily
                suspend our operations and, in our sole discretion, decide
                whether or not to support either branch of the forked protocol
                entirely; in the event Trustledger decides not to support a
                branch of a forked protocol, you will not be given access to the
                assets on that fork. Those assets will be securely held by
                Trustledger and we will not buy or sell them.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                11.1 Your use of the Trustledger Site is subject to
                international export controls and economic sanctions
                requirements. By undertaking any activity on the Trustledger
                Site or through your Trustledger Account, including but not
                limited to sending, receiving, buying, selling, storing or
                trading any cryptocurrency, you agree that you will at all times
                comply with those requirements. In particular, and without any
              </h3>
              <h3>
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                Trustledger Family members! The Trustledger Team and VIP members
                are here to help and share with each other. Join the Trustledger
                Family Chat to enjoy one of the best crypto communities on the
                planet.
              </h3>
              <h3>
            ...
            <div className="termDiv3">
              ...
              <h3>
                13.1 You may close your Trustledger Account by submitting a
                closure request via the Help Centre. Trustledger will action
                such requests once (i) the sum of all Local Currency and
                cryptocurrency balances in your Trustledger Wallet(s) is below
                the Minimum Closure Amount; and (ii) no transactions have taken
                place in your Trustledger Account for a period of at least 30
                days. Such requirements are designed to protect you from loss
                and Trustledger will not action a closure request until they are
                satisfied.
              </h3>
              <h3>
                13.2 YOU ACCEPT AND ACKNOWLEDGE THAT, ONCE YOUR Trustledger
                ACCOUNT IS CLOSED: you will have no further access to it;
                Trustledger will be under no obligation to notify you of, or
                provide to you, any cryptocurrency sent to any receive address
                associated with your Trustledger Account; Trustledger reserves
                the right (but has no obligation) to delete all of your
                information and account data stored on our servers, and also
                reserves the right to retain any information that is required
                for legal or operational reasons;
              </h3>
              <h3>
                13.3 If at the date of closure of your account any Local
                Currency or cryptocurrency remains in your Trustledger Wallet(s)
                (i.e. funds amounting to less than the Minimum Closure Amount),
                you accept and agree that Trustledger shall retain such funds
                and that you shall have no further claim to them. The Minimum
                Closure Amount shall be USD10.00 or the equivalent in your Local
                Currency. You accept and agree that Trustledger shall not be
                liable to you or any third party in relation to the closure of
                your Trustledger Account, the termination of access to your
                Trustledger Account, or for the deletion of your information or
                Trustledger Account data.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                14.1 We reasonably suspect your Trustledger Account to be the
                ...
                the error is rectified; we reasonably suspect your Trustledger
                ...
                we reasonably suspect you or your Trustledger Account is or has
                ...
                reasonably suspect you of taking any action that Trustledger
                considers to be a circumvention of Trustledger controls,
                including but not limited to opening multiple Trustledger
                Accounts; we reasonably suspect your involvement in any attempt
                to gain unauthorised access to any Trustledger Account; your
                Trustledger Account is or appears to be the subject of any
                legal, regulatory or government process and/or we, in our sole
                discretion, consider there to be a heightened risk of legal or
                regulatory non-compliance associated with your Trustledger
                Account; we are compelled to do so by a prima facie valid
                subpoena, court order, or other binding order of a government or
                regulatory authority; your name appears on a government or
                international body sanctions list.
              </h3>
              <h3>
                14.2 Trustledger will make all reasonable efforts to provide you
                with notice of any decision to restrict, suspend or terminate
                your Trustledger Account, unless we are prevented from doing so
                by any legal or regulatory process or requirement, or where
                doing so may compromise Trustledger security and/or risk
                management procedures. You accept and agree that Trustledger is
                under no obligation to disclose to you the fact of or reason for
                any decision to restrict, suspend or terminate your Trustledger
                Account, and shall have no liability to you in connection with
                the restriction, suspension or termination of your Trustledger
                Account.
              </h3>
              <h3>
                14.3 Account termination. Where Trustledger elects to terminate
                your Trustledger Account in accordance with the above, we shall
                ...
                available balance of Supported Cryptocurrency in your
                Trustledger Account above the Minimum Threshold, we will
                liquidate the cryptocurrency and deposit the value realised from
                the liquidation into your Local Currency wallet. The Minimum
                ...
                you and you shall have no claim against Trustledger for any
                losses you may suffer as a result of the liquidation of your
                available balance of Supported Cryptocurrency.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                15.1 YOU MUST NOT USE YOUR Trustledger ACCOUNT TO UNDERTAKE ANY
                OF THE ACTIVITIES OR CATEGORIES OF ACTIVITY SET OUT IN THIS
                SECTION (EACH A “PROHIBITED ACTIVITY”): violation of any laws,
                statutes, ordinance or regulations; undertaking, facilitating or
                ...
                disproportionately large load on Trustledger infrastructure, or
                otherwise taking any action that may negatively affect the
                performance of the TrustledgerSite or Trustledger reputation;
                attempting to gain unauthorised access to the Trustledger Site
                or any Trustledger Account; transmitting or uploading any
                material to the Trustledger Site that contains viruses, Trojan
                horses, worms, or any other harmful programmes; transferring
                your Trustledger Account access or rights to your Trustledger
                Account to a third party, unless as required by law or with
                Trustledger prior consent; paying in to or otherwise supporting
                pyramid schemes, Ponzi schemes, matrix programmes, “get rich
                quick” schemes, multi-level marketing programmes or high-yield
                investment programmes; fraudulent activity, including but not
                limited to taking any actions that defraud Trustledger or a
                Trustledger customer, or the provision of any false, inaccurate,
                or misleading information to Trustledger; transactions involving
                items that may help facilitate or enable illegal activity;
                promote or facilitate hate, violence or racial intolerance; are
                considered obscene; or may be stolen goods or the proceeds of
                crime; transactions involving TOR markets, online gambling sites
                or mixers; sale or purchase of narcotics or controlled
                substances; intellectual property infringement.
              </h3>
              <h3>
                15.2 By opening a Trustledger Account, you confirm that you will
                ...
                Trustledger. Unless you have obtained the prior written approval
                of Trustledger, you accept and agree that you will not use your
                Trustledger Account to conduct or operate any of the following
              ...
              <h3>
                ...
                Trustledger Account if we suspect, in our sole discretion, that
                you are using, or have used, your Trustledger Account in
                association with any of the activities listed above, or any
                similar or related activity, without having obtained the prior
                written approval of Trustledger.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                16.1 The Trustledger Site, your Trustledger Account and any
                related products or services are offered on a strictly “as-is”
                and “where-available” basis and Trustledger expressly disclaims,
                and you waive, all warranties of any kind, whether express or
                implied. Without limiting the generality of the foregoing, the
                Trustledger Site, your Trustledger Account, and any related
                products or services are offered without any warranty as to
            ...
            <div className="termDiv3">
              ...
              <h3>
                17.1 In no event shall Trustledger, its operating entities or
                any other affiliates (including their respective directors,
                members, employees or agents) be liable to you for any direct,
                ...
                loss of profit, loss of revenue, loss of business, loss of
                opportunity, loss of data, whether in contract, tort or
                otherwise, arising out of or in any way connected with your use
                of, inability to use, or unavailability of the Trustledger Site
                and/or your Trustledger Account, including without limitation
                any damages caused by or resulting from any reliance upon any
                information received from Trustledger, or that result from
                mistakes, omissions, interruptions, deletion of files or email,
                errors, defects, viruses, delays in operation or transmission or
                any failure of performance, whether or not resulting from a
                force majeure event, communications failure, theft, destruction
                or unauthorised access to Trustledger’s records, programmes or
                services.
              </h3>
              <h3>
                17.2 In no event will any liability of Trustledger, its
                operating entities or any other affiliates (including their
                respective directors, members, employees or agents) arising in
                relation to your use of the Trustledger Site or your Trustledger
                Account, exceed (in aggregate) the fees earned by Trustledger in
                connection with your use of your Trustledger Account in the six
                ...
                jurisdiction. Because some jurisdictions do not allow the
                exclusion of certain warranties or the limitation or exclusion
                of liability for incidental or consequential damages, some of
                the limitations in this section may not apply to you.
              </h3>
            </div>
            ...
            <div className="termDiv3">
              ...
              <h3>
                ...
                any claim or dispute that arises in relation to the Trustledger
                Site, your Trustledger Account or these Terms, within 30 days of
              ...
              <h3>
                ...
                extent permissible by law, you and Trustledger each agree that
                each may bring any Dispute against the other only in your or its
                ...
                permissible by law, unless both you and Trustledger agree
            ...
            <div className="termDiv3">
              ...
              <h3>
                19.1 If for any reason Payward is holding Funds in your
                Trustledger Account on your behalf, and Payward is unable to
                return your Funds to your designated External Account after a
                period of inactivity, then Payward may report and remit such
                Funds in accordance with applicable state unclaimed property
                laws.
              </h3>
              <h3>
